...
- The install-command script will make a copy of the refresh-roon script into `/opt/homebrew/bin` and give it execution permissions to make it globally executable
  - ```bash
    zsh install-command
    ```
