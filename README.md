...
- The `install-command` script will make a copy of the refresh-roon script into `/opt/homebrew/bin` and give it execution permissions so it can run from any directory in the terminal
    ```bash
    $ zsh install-command
    ```
